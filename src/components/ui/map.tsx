...
/* eslint-disable better-tailwindcss/enforce-canonical-classes, better-tailwindcss/no-duplicate-classes -- MapCN uses Tailwind v4 functional color syntax that this plugin does not parse. */
  ...
  layers: [
    {
      id: "background",
      type: "background",
      paint: { "background-color": "rgba(0, 0, 0)" },
    },
  ],
}
...
function DefaultLoader() {
  return (
    <div className="bg-oklch(1 0 0)/50 dark:bg-oklch(0.145 0 0)/50 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-xs">
      <div className="flex gap-1">
        <span className="bg-oklch(0.556 0 0)/60 dark:bg-oklch(0.708 0 0)/60 size-1.5 animate-pulse rounded-full" />
        <span className="bg-oklch(0.556 0 0)/60 dark:bg-oklch(0.708 0 0)/60 size-1.5 animate-pulse rounded-full [animation-delay:150ms]" />
        <span className="bg-oklch(0.556 0 0)/60 dark:bg-oklch(0.708 0 0)/60 size-1.5 animate-pulse rounded-full [animation-delay:300ms]" />
      </div>
    </div>
  )
}
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-oklch(1 0 0) text-oklch(0.145 0 0) border-oklch(0.922 0 0) dark:bg-oklch(0.205 0 0) dark:text-oklch(0.985 0 0) dark:border-oklch(1 0 0 / 10%) relative max-w-62 rounded-md border p-3 shadow-md",
...
function MarkerTooltip({ children, className, ...popupOptions }: MarkerTooltipProps) {
  ...
  return createPortal(
    <div
      className={cn(
        "bg-oklch(0.145 0 0) text-oklch(1 0 0) dark:bg-oklch(0.985 0 0) dark:text-oklch(0.145 0 0) pointer-events-none rounded-md px-2 py-1 text-xs text-balance shadow-md",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className,
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "text-oklch(0.145 0 0) dark:text-oklch(0.985 0 0) text-[10px] font-medium",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-oklch(0.922 0 0) bg-oklch(1 0 0) [&>button:not(:last-child)]:border-oklch(0.922 0 0) dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.145 0 0) dark:[&>button:not(:last-child)]:border-oklch(1 0 0 / 10%) flex flex-col overflow-hidden rounded-md border shadow-sm [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  )
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-oklch(0.708 0 0) dark:focus-visible:ring-oklch(0.556 0 0) focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset",
